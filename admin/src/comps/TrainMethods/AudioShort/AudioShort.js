    ...
    return <div className={'audio-short rel '}
        ...
        <div className="tc w100 rel textwraps">
            ...
            <div className={"svgContainer rel"
                ...
                {/*{true && <div className="afade countDownBeforeStart">*/}
                    ...
                </div>}
                    ...
                    <div className="svg-box">
                        ...
                        {!isExam && <>
                            {!countDownBeforeStart && !!attempts && <div className="rewriteMore">
                                ...
                                <span>
                                    {t('repeatRec')}
                                    {isRewriteDisabled && <div>{t('availableLater')}</div>}
                                </span>
                            </div>}
                        </>}
            ...
            {!isNextMoveOnly && <>
                {recording && <div style={{marginTop: '20px'}} className={'afade'}><Button
                    color={4} size={'sm'}
                                                                                           onClick={(scb) => {
                                                                                               scb && scb()
                                                                                               toggleRecoord()
                            ...
                            {!!rate && !!attemptsForNextIfNot5 && !!disabled && <div>
                                <small>
                                    <div className={'error animChild ib'}>
                                        ...
                                        <div>
                                            {t('warnMsgNot5Available')} #{attemptsForNextIfNot5}
                                        </div>
                                    </div>
                                </small></div>}
                                ...
                                return (
                                    <>
                                        <button key={ind}
                                                ...
                                                className={'btn btn-sm ' + (selectedNames[it] ? 'btn-primary btn-active active selected' : 'btn-light')}
                                        >#{names[it]}</button>
                                    </>
        ...
        {initMic && <div className="fadeDelay">
            ...
            <div className="initMicCont">{t('micIniting')}
            </div>
        </div>}
...
function micError() {
    ...
    !preventMicError && alert(t('micProblemErr'))
}
